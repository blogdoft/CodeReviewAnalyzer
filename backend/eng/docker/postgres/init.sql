...
BEGIN
    ...
    IF EXISTS (SELECT FROM pg_tables where schemaname = 'public' AND tablename = 'USERS') THEN
        ...
        UPDATE public."USERS" SET "ACTIVE"=false WHERE "EXTERNAL_IDENTIFIER" = '43c750d8-c8a3-495a-80fc-1d33d395e375';
        ...
        UPDATE public."USERS" SET "ACTIVE"=true WHERE "EXTERNAL_IDENTIFIER" = 'cee59558-2596-4b72-9e20-5739b9f22270';
        ...
        UPDATE public."USERS" SET "ACTIVE"=true WHERE "EXTERNAL_IDENTIFIER" = 'ce5c7717-f3af-4fdf-95aa-8418e348fe56';
        UPDATE public."USERS" SET "ACTIVE"=true WHERE "EXTERNAL_IDENTIFIER" = 'dc036e5f-6b4d-43c4-8f92-3a287179c544';
        UPDATE public."USERS" SET "ACTIVE"=true WHERE "EXTERNAL_IDENTIFIER" = 'de149bc6-874d-4ea4-989e-282b2fa33c09';
        UPDATE public."USERS" SET "ACTIVE"=true WHERE "EXTERNAL_IDENTIFIER" = 'd2cbd8ef-5242-4701-9c2f-417ed40ce395';
        ...
        UPDATE public."USERS" SET "ACTIVE"=true WHERE "EXTERNAL_IDENTIFIER" = '731473db-bbab-4f33-9700-9c9031736c83';
        UPDATE public."USERS" SET "ACTIVE"=true WHERE "EXTERNAL_IDENTIFIER" = '5b221bc1-4c7b-4d42-9f84-256834545c51';
        ...
        UPDATE public."USERS" SET "ACTIVE"=true WHERE "EXTERNAL_IDENTIFIER" = '997b3c7e-3954-46fa-b2da-1a94be823ea0';
