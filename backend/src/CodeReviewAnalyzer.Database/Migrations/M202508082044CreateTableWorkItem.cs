...
public class M202508082044CreateTableWorkItem : Migration
{
    ...
    private void CreateWorkItems()
    {
        Create.Table("work_items")
            ...
            .WithColumn("tenant_id")
                .AsInt16()
                .NotNullable()
                .ForeignKey("fk_work_items__tenant_id", "tenants", "id")
                .Indexed("idx_fk_work_items__tenant_id")
                .WithColumnDescription("FK for tenant.")
            .WithColumn("shared_key")
                .AsGuid()
                .NotNullable()
                .Indexed("idx_uk_work_items__shared_key")
        ...
        Create.Index("idx_uk_work_items__external_id")
            .OnTable("work_items")
    ...
    private void CreateWorkItemsPullRequestsRelation()
    {
        Create.Table("work_items_pull_requests")
            .WithColumn("tenant_id")
                .AsInt16()
                .NotNullable()
                .ForeignKey("fk_work_items_pull_requests__tenant_id", "tenants", "id")
                .Indexed("idx_fk_work_items_pull_requests__tenant_id")
                .WithColumnDescription("FK for tenants")
            .WithColumn("work_items_id")
                .AsInt64()
                .NotNullable()
                .ForeignKey("fk_work_items_pull_requests__work_item_id", "work_items", "id")
                    .OnDeleteOrUpdate(System.Data.Rule.Cascade)
                .Indexed("idx_fk_work_items_pull_requests__work_item_id")
            ...
            .WithColumn("pull_request_id")
                .AsInt64()
                .NotNullable()
                .ForeignKey("fk_work_Items_pull_requests__pull_request_id", "pull_requests", "id")
                    .OnDeleteOrUpdate(System.Data.Rule.Cascade)
                .Indexed("idx_fk_work_Items_pull_requests__pull_request_id")
                .WithColumnDescription("Fk to pull request")
            .WithColumn("pull_request_external_id")
                .AsString(255)
                .Nullable()
                .WithColumnDescription("External id for late relation");
    }
    ...
    private void CreateWorkItemSelfRelation()
    {
        Create.Table("work_item_self_relation")
            ...
            .WithColumn("work_item_id_root")
                .AsInt64()
                .NotNullable()
                .ForeignKey("fk_work_item_self_relation__work_item_id_root", "work_items", "id")
                    .OnDeleteOrUpdate(System.Data.Rule.Cascade)
                .Indexed("idx_fk_work_item_self_relation__work_item_id_root")
                .WithColumnDescription("The work item root")
            .WithColumn("work_item_id_related")
                .AsInt64()
                .NotNullable()
                .ForeignKey("fk_work_item_self_relation__work_item_id_related", "work_items", "id")
                    .OnDeleteOrUpdate(System.Data.Rule.Cascade)
                .Indexed("idx_fk_work_item_self_relation__work_item_id_related")
