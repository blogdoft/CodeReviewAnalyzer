using CodeReviewInsight.Api.Configs;
using CodeReviewInsight.Api.Extensions;
using CodeReviewInsight.Api.Filters;
...
try
{
    ...
    CodeReviewInsightDatabaseExtensions.ExecuteMigration(app.Services);
